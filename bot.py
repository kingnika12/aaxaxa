...
# ===== CONFIGURATION =====
ALLOWED_USER_IDS = [YOUR_DISCORD_ID]  # Replace with your Discord ID
...
# ===== START BOT =====
bot = NetworkTestBot()
bot.run("MTM1NTk2Njg5ODI5NDEwMDA1MQ.GNCV3-.yWHRxjuwiTaJH0IJ9ZzmBzUYllxluu5xgL4gRQ")  # Replace with your actual token